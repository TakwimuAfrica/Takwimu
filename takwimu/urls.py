...
from takwimu.views import CountryProfile, AboutUsPage, ContactUsPage, SupportServicesPage

urlpatterns = static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT) + \
              static(settings.STATIC_URL, document_root=settings.STATIC_ROOT) + \
              [
                url(r'^about/contact', ContactUsPage.as_view(), name='about_contact'),
                url(r'^about/support-services', SupportServicesPage.as_view(), name='about_dataservices'),
