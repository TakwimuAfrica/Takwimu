...
from takwimu.views import HomePageView, SupportServicesIndexView, AboutUsView, LegalView, TopicView, SearchView, SDGGeographyDetailView, SDGHomePageView
...
urlpatterns = static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT) + \
              ...
              [
                  ...
                  url(r'^sdg/$', SDGHomePageView.as_view(), name='sdg_view'),
                  url(r'^sdg/(?P<geography_id>\w+-\w+)(-(?P<slug>[\w-]+))?/$', SDGGeographyDetailView.as_view(), name='sdg_details'),
