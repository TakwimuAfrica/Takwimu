...
from takwimu.views import HomePageView, SupportServicesIndexView, LegalView, \
    TopicView, SearchView, IndicatorsGeographyDetailView, SDGIndicatorView, \
    SearchAPIView, AutoCompleteAPIView
