...
from takwimu.views import HomePageView, SupportServicesIndexView, AboutUsView, LegalView, TopicView, SearchView, SDGView
...
urlpatterns = static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT) + \
              ...
              [
                  ...
                  url(r'^sdg/$', SDGView.as_view(), name='sdg_view'),
