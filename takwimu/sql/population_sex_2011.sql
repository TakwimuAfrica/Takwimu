...
CREATE TABLE public.population_sex_2011 (
    ...
    "population_sex_2011" character varying(128) NOT NULL,
    total integer
);
...
--
-- Name: population_sex_2011 pk_population_sex_2011; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.population_sex_2011
    ADD CONSTRAINT pk_population_sex_2011 PRIMARY KEY (geo_level, geo_code, geo_version, "population_sex_2011");
