...
ALTER TABLE IF EXISTS ONLY public.incidence_of_malaria_per_1000_population_at_risk DROP CONSTRAINT IF EXISTS pk_incidence_of_malaria_per_1000_population_at_risk;
DROP TABLE IF EXISTS public.incidence_of_malaria_per_1000_population_at_risk;
SET default_tablespace = '';

SET default_with_oids = false;

--
-- Name: incidence_of_malaria_per_1000_population_at_risk; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.incidence_of_malaria_per_1000_population_at_risk (
    geo_level character varying(15) NOT NULL,
    geo_code character varying(10) NOT NULL,
    geo_version character varying(100) DEFAULT ''::character varying NOT NULL,
    incidence_of_malaria_per_1000_population_at_risk_year character varying(128) NOT NULL,
    total integer
);


--
-- Data for Name: incidence_of_malaria_per_1000_population_at_risk; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.incidence_of_malaria_per_1000_population_at_risk (geo_level, geo_code, geo_version, incidence_of_malaria_per_1000_population_at_risk_year, total) FROM stdin;
...
--
-- Name: incidence_of_malaria_per_1000_population_at_risk pk_incidence_of_malaria_per_1000_population_at_risk; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.incidence_of_malaria_per_1000_population_at_risk
    ADD CONSTRAINT pk_incidence_of_malaria_per_1000_population_at_risk PRIMARY KEY (geo_level, geo_code, geo_version, incidence_of_malaria_per_1000_population_at_risk_year);
