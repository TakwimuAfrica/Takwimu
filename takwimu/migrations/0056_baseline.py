...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('takwimu', '0055_indicatorblock_summary'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                default='Other topics in', max_length=1024, verbose_name='title'),
        ),
        migrations.AddField(
            model_name='countryprofilessetting',
            name='read_next_title',
            field=models.CharField(
                default='Read next...', max_length=1024, verbose_name='title'),
        ),
        migrations.AddField(
            model_name='countryprofilessetting',
            name='view_country_content',
            field=wagtail.core.fields.StreamField([('view_country_content', wagtail.core.blocks.StructBlock([('title', wagtail.core.blocks.CharBlock(default='View analysis or data for a specific country', max_length=1024)), ('content_selection_label', wagtail.core.blocks.CharBlock(
                default='Show me', max_length=1024)), ('country_selection_label', wagtail.core.blocks.CharBlock(default='for', max_length=1024)), ('view_content_action_label', wagtail.core.blocks.CharBlock(default='Go', max_length=1024))]))], blank=True, verbose_name='View Country Content Section'),
        ),
        migrations.AddField(
            model_name='faqsetting',
            name='description',
        ...
        migrations.AddField(
            model_name='indexpage',
            name='hero',
            field=wagtail.core.fields.StreamField([('hero', wagtail.core.blocks.StructBlock([('title', wagtail.core.blocks.CharBlock(default='Actionable insights for African changemakers', max_length=1024)), ('tagline', wagtail.core.blocks.RichTextBlock(
                default='<p>Data driven analysis on development policies, programmes & outcomes in 10 African countries <a href="/about">find out more about us</a></p>')), ('watch_video_link_label', wagtail.core.blocks.CharBlock(default='Watch the overview video', max_length=1024))]))], blank=True),
        ),
        migrations.AddField(
            model_name='indexpage',
            name='latest_news_stories',
            field=wagtail.core.fields.StreamField([('latest_news_stories_content', wagtail.core.blocks.StructBlock([('title', wagtail.core.blocks.CharBlock(default='Latest News & Stories', max_length=1024)), ('description', wagtail.core.blocks.RichTextBlock(
                default='<p>Lorem ipsum dolor sit amet, adipiscing elitauris con lorem ipsum dolor sit amet.</p>', required=False)), ('read_more_link_label', wagtail.core.blocks.CharBlock(default='Read more stories on Medium', max_length=1024))]))], blank=True),
        ),
        migrations.AddField(
            model_name='indexpage',
            name='making_of_takwimu',
            field=wagtail.core.fields.StreamField([('making_of_takwimu_content', wagtail.core.blocks.StructBlock([('title', wagtail.core.blocks.CharBlock(default='The Making of Takwimu', max_length=1024)), ('description', wagtail.core.blocks.RichTextBlock(
                default='<p>Highlights from the Takwimu design sprint at iHub Kenya.</p>', required=False)), ('link', wagtail.core.blocks.URLBlock(default='https://www.youtube-nocookie.com/embed/DvDCCETHsTo'))]))], blank=True),
        ),
        migrations.AddField(
            model_name='indexpage',
        ...
        migrations.AddField(
            ...
            name='label',
            field=models.CharField(
                default='Politics', help_text="Title of profile name i.e. county name doesn't explain what the page contains", max_length=1024, verbose_name='label'),
        ),
        migrations.AddField(
            model_name='supportservicessetting',
            name='description',
        ...
        migrations.AlterField(
            model_name='aboutpage',
            name='methodology',
            field=wagtail.core.fields.StreamField([('methodology_content', wagtail.core.blocks.StructBlock([('label', wagtail.core.blocks.CharBlock(default='Methodology', help_text='Short title used in navigation, etc.', max_length=255)), ('title', wagtail.core.blocks.CharBlock(default='Methodology', max_length=1024)), ('description', wagtail.core.blocks.RichTextBlock(
